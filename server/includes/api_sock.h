...
extern signed long long int LOCK_ID;
extern long SIZE_FILE;

typedef struct {
    int state;
    signed long long int response;
    signed long long int is_error;
    void *sendbuff;
    int sendbuff_end;
    int sendptr;
} conn_state_t;
...
int readFile(const char*, void **, signed long long int *);
int helper_receive(void **buff, signed long long int *size);
int readNFiles(int , const char *);
char* cwd();
char *get_full_path(char *, signed long long int );
